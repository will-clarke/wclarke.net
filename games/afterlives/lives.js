...
endings: {
  ...
  /* THE SHOP */
  e_small_change: {story:"shop", title:"SIXTY YEARS OF SMALL CHANGE", bars:[3,3,1],
  ...
  e_kettle: {story:"shop", title:"THE KETTLE", bars:[4,2,1],
  ...
  /* SCHOOL */
  e_beetle: {story:"school", title:"FOUR HUNDRED KINDS OF BEETLE", bars:[4,3,2],
  ...
  e_sky: {story:"school", title:"HALF THE SKY", bars:[3,4,1],
  ...
  e_chalk: {story:"school", title:"CHALK", bars:[3,4,1],
  ...
  e_cup: {story:"school", title:"HER NAME ON THE CUP", bars:[3,3,1],
  ...
  e_joint: {story:"school", title:"JOINT FIRST", bars:[4,2,1],
  ...
  /* THE TIMBER */
  e_widowmaker: {story:"timber", title:"WIDOWMAKER", bars:[1,2,3],
  ...
  e_oldstand: {story:"timber", title:"THE OLD STAND", bars:[3,4,0],
  ...
  e_firewatch: {story:"timber", title:"FIRE-WATCH", bars:[4,3,0],
  ...
  /* THE BOATS */
  e_storm: {story:"boats", title:"THE NIGHT THE FLEET CAME HOME", bars:[3,5,1],
  ...
  e_seakeeps: {story:"boats", title:"WHAT THE SEA KEEPS", bars:[2,2,1],
  ...
  e_regatta: {story:"boats", title:"THE REGATTA", bars:[5,1,0],
  ...
  e_stall: {story:"boats", title:"FRESH TODAY, ALWAYS", bars:[4,3,2],
