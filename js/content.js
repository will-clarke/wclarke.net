...
const SEED_CONTENT = {
  ...
  '0,-1|-2,1|-1,1|1,-1|0,1':  { note: 'consciousness is more common than we think: animals - probably insects too - feel far more than we give them credit for. it stops being a great mystery once you accept it’s just a brain doing the feeling.', glyph: '🐜' },
  '0,-1|-2,1|-1,1|1,-1|-1,1': { note: 'ai can be conscious, and to some extent probably already is.', glyph: '💡' },
  '0,-1|-2,1|-1,1|1,-1|-1,0': { note: 'total symmetry acolyte. everything is symmetrical - including, i suspect, our emotions.', glyph: '🦋' },
  '0,-1|-2,1|-1,1|1,-1|0,-1': { note: 'intelligence is somehow underrated. so is simplicity.', glyph: '💎' },
  '0,-1|-2,1|-1,1|1,-1|1,-1': { note: 'evolution explains far more about life than we usually admit. it is the ultimate force acting on animals - us included.', glyph: '🧬' },
  '0,-1|-2,1|-1,1|1,-1|2,0':  { note: 'it’s crazy how simple rules can create complexity.', glyph: '🌱' },
  '0,-1|-2,1|-1,1|1,-1|1,1':  { note: 'there’s often wisdom in old-fashioned customs and morality.', glyph: '🏺' },
  '0,-1|-2,1|-1,1|1,-1|0,2':  { note: 'poverty is the natural state; prosperity is the anomaly. we should spend far more time thinking about where prosperity comes from.', glyph: '🌾' },
  '0,-1|-2,1|-1,1|1,-1|-1,2': { note: 'capitalism is by far the best thing humans have discovered - it has lifted billions out of poverty. economic progress isn’t everything, though.', glyph: '📈' },
  '0,-1|-2,1|-1,1|1,-1|-2,2': { note: 'we’re evolving ai minds the same way ours were evolved. if they end up feeling things, we’ll have made trillions of them - worth thinking about before, rather than after.', glyph: '🧠' },
  '0,-1|-2,1|-1,1|1,-1|-1,-1': { note: 'i wonder whether some potential inventions are best left undiscovered.', glyph: '🕳' },
  '0,-1|-2,1|-1,1|1,-1|0,-2': { note: 'families are important. so is disagreement - conflict is inevitable, and not always bad.', glyph: '🏡' },
  '0,-1|-2,1|-1,1|1,-1|1,-2': { note: 'we’ve recently become rather soft. there’s plenty of grit left in us.', glyph: '🪨' },
  '0,-1|-2,1|-1,1|1,-1|2,-2': { note: 'transparency beats privacy. i’d be happy for everything to be public.', glyph: '🔎' },
  '0,-1|-2,1|-1,1|1,-1|2,-1': { note: 'harnessing energy is what defines humanity: fire, water wheels, steam, nuclear. we should be aiming to use more power per person, not less.', glyph: '⚡' },
  '0,-1|-2,1|-1,1|1,-1|-2,0': { note: 'factory farming is probably the worst thing we currently do. i still eat meat. these are thoughts, not virtues.', glyph: '🥩' },
...
const DECENT_SLUGS = ['hydra', 'mirror', 'tile', 'shipshape', 'loom', 'drip', 'allotmatic',
  'antwar'];
const GAME_GLYPHS = { shipshape: '🚢', fathom: '🐙', lumen: '🏮', cascade: '🌊',
  ...
  hydra: '🐉', allotmatic: '🥕', trine: '🔺', kaleid: '❋', antwar: '⚔', ants: '🐜' };
const PINNED_GAMES = [
