...
const SEED_CONTENT = {
  ...
  '-1,2': { section: true, glyph: '💭', title: 'philosophical musings' },
  '-1,2|1,0':  { note: 'i’m a fully paid-up ai doomer: we should be taking the risks far more seriously. progress is probably inevitable anyway - competition sees to that - so we’d better hope it lands well.', glyph: '🤖' },
  '-1,2|0,1':  { note: 'consciousness is more common than we think: animals - probably insects too - feel far more than we give them credit for. it stops being a great mystery once you accept it’s just a brain doing the feeling.', glyph: '🐜' },
  '-1,2|-1,1': { note: 'ai can be conscious, and to some extent probably already is.', glyph: '💡' },
  '-1,2|-1,0': { note: 'total symmetry acolyte. everything is symmetrical - including, i suspect, our emotions.', glyph: '🦋' },
  '-1,2|0,-1': { note: 'intelligence is somehow underrated. so is simplicity.', glyph: '💎' },
  '-1,2|1,-1': { note: 'evolution explains far more about life than we usually admit. it is the ultimate force acting on animals - us included.', glyph: '🧬' },
  '-1,2|2,0':  { note: 'it’s crazy how simple rules can create complexity.', glyph: '🌱' },
  '-1,2|1,1':  { note: 'there’s often wisdom in old-fashioned customs and morality.', glyph: '🏺' },
  '-1,2|0,2':  { note: 'poverty is the natural state; prosperity is the anomaly. we should spend far more time thinking about where prosperity comes from.', glyph: '🌾' },
  '-1,2|-1,2': { note: 'capitalism is by far the best thing humans have discovered - it has lifted billions out of poverty. economic progress isn’t everything, though.', glyph: '📈' },
  '-1,2|-2,2': { note: 'inequality isn’t bad in itself. most taxes, on the other hand, are immoral: taking people’s labour under threat of imprisonment.', glyph: '⚖' },
  '-1,2|-1,-1': { note: 'i wonder whether some potential inventions are best left undiscovered.', glyph: '🕳' },
  '-1,2|0,-2': { note: 'families are important. so is disagreement - conflict is inevitable, and not always bad.', glyph: '🏡' },
  '-1,2|1,-2': { note: 'we’ve recently become rather soft. there’s plenty of grit left in us.', glyph: '🪨' },
  '-1,2|2,-2': { note: 'transparency beats privacy. i’d be happy for everything to be public.', glyph: '🔎' },
  '-1,2|2,-1': { note: 'harnessing energy is what defines humanity: fire, water wheels, steam, nuclear. we should be aiming to use more power per person, not less.', glyph: '⚡' },
