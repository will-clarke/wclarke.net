...
** TODO Function Composition is super cool :haskell:fp:
:PROPERTIES:
:EXPORT_FILE_NAME: function-composition-is-super-cool
:END:
...
** TODO Golang type switching
** TODO Nix is cool
** TODO Home-manager works well
** TODO GNU stow is an effective way of dealing with dotfiles
** TODO S3 can deploy websites really easily!
...
# :END:
eg. jq
** TODO learn some basic sql :sql:
# :PROPERTIES:
# :EXPORT_FILE_NAME: document-everything
# :EXPORT_DATE: 2019-06-08
# :END:
** TODO learn some basic excel / google spreadsheet operations
# :PROPERTIES:
# :EXPORT_FILE_NAME: document-everything
# :EXPORT_DATE: 2019-06-08
# :END:
Use the right tool for the job!
** TODO Record shell commands / sql queries you run
# :PROPERTIES:
# :EXPORT_FILE_NAME: document-everything
# :EXPORT_DATE: 2019-06-08
# :END:
...
Documentation!
** TODO get comfortable creating bash executables
# :PROPERTIES:
# :EXPORT_FILE_NAME: document-everything
# :EXPORT_DATE: 2019-06-08
# :END:
** TODO keep track of handy hints
# :PROPERTIES:
# :EXPORT_FILE_NAME: document-everything
# :EXPORT_DATE: 2019-06-08
# :END:
** TODO Take logging seriously
** TODO learn the difference between functions & methods
** TODO `.env` files are your friend
** TODO use ssh git github
git config --global url."git@github.com:".insteadOf "https://github.com/"
** TODO Priotisation is stupidly important.
Your job isn't to just make stuff. It's to make the *right* stuff
** TODO Learn the basics of HTTP
Get comfy with command-line cURL request
** TODO map out all domain concepts before doing anything involving them
You need to *understand* things before you can fix / improve / work on them
** TODO have fun along the way
** TODO try static typing.. it can catch loads of bugs
** TODO guids > ids normally
** TODO get familiar with ssh & ~/.ssh/config  && /etc/hosts files
** TODO screenshots help a lot
** TODO over communicationn is tricky
** TODO formatting & style guides are overrated
** TODO don't over-optimise
** TODO don't over-promise
** TODO haters gonna hate
** TODO scepticism is good
** TODO read documentation - not just stack overflow
** TODO adding sql indexes is cool
** TODO Get used to using AWS / GCP
** TODO Don't just build things! Complete them! Market them!
Try to create a side-hustle or business or portfolio
** TODO Invest time in staring at Trello / Jira. You're also a product person
** TODO lambdas are the future! serverless FTW
** TODO Keep learning, reading and absorbing stuff
** TODO Learn more than one language. Get a broad base
** TODO Be confident
you're getting paid to work with people rather than be shy or polite
** TODO Move slowly
but deliberately
** TODO keep things simple
do things the simple way
only generalise when you have to
don't shy away from doing this manually
** TODO Don't be scared to read some source code & try to understand it
** TODO time-box things.
Don't get carried away and spend all your time doing something inefficient
** TODO Reevaluate priorities reguarly
pomodoro technique
** TODO Sometimes you just need a load of time to do things
** TODO learn some s3 command lines
https://github.com/aws-samples/aws-modern-application-workshop/ is good
** TODO Learn the basics - don't take shortcuts.
Eg. implement password hashing and salting yourself, rather than a library. It's important to see how stuff works
** TODO Document starting a new Hugo blog
** TODO Document X230 set up!
** TODO Standing desks are cool
** TODO exercise is important - just walking's fine. good for clearing the mind
** TODO Wake up early and do stuff in the morning
** TODO Get used to using docker!±
docker run -it --rm alpine mkpasswd
** TODO passwd & /etc/shadow & /etc/passwd
** TODO use git everywhere!
